...
export class GameOverComponent {
    ...
    private createHeadline(): HTMLElement {
        ...
        headLine.classList.add('game-over-screen__headline');
    ...
    private createTextLine(): HTMLElement {
        ...
        textLine.classList.add('game-over-screen__textline');
        textLine.innerText = 'Final score';
        return textLine;
    }

    private buildScoreBoard(players: Player[]): HTMLElement {
        const scoreBoard:PlayerScoreBordComponent = new PlayerScoreBordComponent(this.theme);
